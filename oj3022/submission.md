...
```text
โจทย์ให้แปลงอุณหภูมิ  โดยรับค่าจากอุณหภูมิหนึ่ง แล้วให้กรอกว่าจะแปลงค่าเป็นอุณหภูมิในหน่วยไหน
```
...
```text
รับ input อุณหภูมิ หน่วย และหน่วยของอุณหภูมิใหม่ จากนั้นแปลงเป็นค่ากลาง 1 ค่า(เลือก 1 หน่วย) จากนั้นค่อยเช็คโดยเข้าเงื่อนไข หน่วยของอุณหภูมิใหม่ = c สามารถแสดงผลออกมาได้เลย แต่หาเป็นกรณีที่แปลงเป็นหน่วยอื่นต้องนำไปคำนวนเพื่อแปลงหน่วยก่อนจึงแสดงผลออกมาตามหน่วยของอุณหภูมิใหม่ที่ต้องการ โดยที่ผลลัพธ์ที่ออกมาจะต้องเป็นทศนิยม 2 ตำแหน่ง 
```
...
```text
ทำเหมือนแผนแรก แต่หน่วยกลางของอุณหภูมิที่เลือกใช้คือ หน่วยC
```
...
```text
เพื่อเทศว่าหากกรอกตัวพิมพ์เล็กจะรับผ่านหรือไใม่
```
...
```text
เพื่อเทสว่าการแปลงหน่วยเป็นค่ากลาง สามารถใช้ได้จริงหรือไม่
```
...
```text
เพื่อเทสการรับค่าว่าหากรับค่าเป้นจำนวนติดลบสามารถแสดงผลได้อย่างถูกต้องหรือไ่ม่
```
