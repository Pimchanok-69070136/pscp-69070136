...
```text
โจทย์ให้หาเงินที่ต้องจ่ายที่รวมค่าบริกการและ Vat 7% โดยที่มีเงื่อนว่าค่าบริการต้องอย่างน้อย 50 บาท แต่ไม่เกิน 1000
```
...
```text
รับค่าเงินเข้ามาก่อนจากนั้นเอามาคำนวนค่าบริกการ และสร้างเงื่อนไขว่าถ้าค่าบริการน้อยกว่า 50 ให้คิดราคา+50(ค่าบริการ)จากนั้นค่อเอาราคาส่วนนั้นมา+ vat 7% elif ถ้าค่าบริการมากกกว่า 1000 ให้คิดราคา+1000แล้วค่อยเอาไป+vat 7%  แต่หากไม่ตรงเงินไขใดเลยให้เอาค่าอาหาร+ค่าบริการแล้วจึงนำไป+ vat 7% เลย
```
...
```text
เพื่อทดสอบเงื่อไขแรกที่ค่าบริการน้อยกว่า 50
```
...
```text
เพื่อทดสอบเงื่อนไขสองที่ค่าบริการมากกว่า 1000
```
...
```text
เพื่อเทสว่ากาไม่ตรงกับเงื่อนไขใดเลยจะสามารถคิดราคาออกมาได้ถูกต้องหรือไม่
```
