...
```text
รับค่าตัวย่อของชื่อไพ่นั้นๆ แล้วให้เราแปลงเป็นชื่อเต็มของไพ่ เช่นinput QS
...
```text
รับค่าตัวย่อ โดยที่เราจะใช้ strip เพื่อแยก ตัวแรกกับตัวที่ 2 ออกจากกัน  โดยเราจะเก็ก็บตัวแรกคือแต้มมันจะมีตั้งแต่ 2-10 หรือ A J K Q โดยเราจะดึงตัวอักษรจากตัวแรก จนถึงรองสุดท้าย แล้วแยกเก็บตัวอักษรสุดท้ายคือกลุ่มไพ่ มี D H S C จากนั้นเราก้จะเก็บค่าแบบ dic เพื่อที่เราจะสามารถดึงค่าชื่ออกมา โดยใช้แค่ key จากนั้น print ค่าออกมา โดยprint rank_name of  num_text โดย key เราจะใช้จาก rank last
```
...
```text
รับค่าตัวย่อ โดยที่เราจะใช้ strip เพื่อแยก ตัวแรกกับตัวที่ 2 ออกจากกัน  โดยเราจะเก็ก็บตัวแรกคือแต้มมันจะมีตั้งแต่ 2-10 หรือ A J K Q โดยเราจะดึงตัวอักษรจากตัวแรก จนถึงรองสุดท้าย แล้วแยกเก็บตัวอักษรสุดท้ายคือกลุ่มไพ่ มี D H S C จากนั้นเราก้จะเก็บค่าแบบ dic เพื่อที่เราจะสามารถดึงค่าชื่ออกมา โดยใช้แค่ key จากนั้น print ค่าออกมา โดยprint rank_name of  num_text โดย key เราจะใช้จาก rank last
เหมือนกับวิธีแรกที่คิดเอาไว้ แต่มีการหาข้อมูลเพิ่มเติมเกี่ยวกับวิธีการใช้ dic
```
...
```text
เพื่อเทสว่าถ้าตัวแรก เป็นตัวอักษรจะสาามรถดึงค่าออกมาได้มั๊ย
```
...
```text
เพื่อเทสว่าถ้าตัวแรกเป็นตัวแรกจะสามารถแสดงค่าอออกมาได้หรือไม่
```
...
```text
เพื่อเทสว่า ถ้าหากตัวแรกเป็นเลข 2 หลักจะสามารถแสดงค่าออกมาได้หรือไม่
```
