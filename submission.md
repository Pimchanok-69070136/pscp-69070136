...
```text
จากโจทย์ คือ
input : ให้เรารับค่าตัวอักษร 5 ตัว แล้ว
output : จะออกมาเป็นตัวอักษรที่สลับจากหลังไปหน้าโดยจะต้องเป็นตัวพิมพ์เล็กเท่านั้นด้วย
```
...
```text
รับค่าinputเข้ามาก่อน
และตั้งเงื่อนไขว่า จำนวนตัวอักษรต้องเท่ากับ 5 เหมือนที่โจทย์กำหนด
จากนั้นค่อยอสดงผลออกมาโดยที่เราจะต้องทำให้มันเป็นพิมพ์เล็กทั้งหมด แล้วจึงใช้String Slicingในการกลับด้าน
จึงทำให้ผลลัพธ์แสดงจากตัวสุดท้ายไปตัวเเรก
```
...
```text
เหมือนวิธีแรกที่คิดไว้ แต่มีการค้นหาวิธีในการใช้ String Slicing
```
...
```text
เพื่อเทสเงื่อนไขที่ใส่ไปว่าจำนวนตัวอักษรต้องมีแค่ 5 เท่านั้น
```
...
```text
ต้องการทดสอบที่เขียนให้เป็นlowerทั้งหมดว่าได้ผลมั๊ย
```
...
```text
เทสว่าหากมีตัวพิมพ์ให้ญ่อยู่ด้วยจะเป็นพิมพ์เล็กมั้ย
```
