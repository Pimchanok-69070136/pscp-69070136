...
```text
ให้เราเขียนโปรกแกรมที่แสดงฤดูต่างๆตามเงื่อนไข โดยที่เดือนที่1-3เป็นฤดูหนาว 4-6ฤดูใบไม้ผลิ 7-9เป็นฤดูร้อน 10-12เป็นฤดูใบไม้ร่วง แต่ถ้าหากเป็นวันที่21 ของเดือน 3 6 9 12 จะเปลี่ยนเป็นฤดูถัดไป
```
...
```text
หลังจากรับค่าวันที่และเดือนจะเข้าเงื่อนไขโดยที่ถ้าตรงกับเดือน3และตั้งแต่วันที่ 21จะให้แสดงค่าเป็นฤดูใบไม้ผลิ หากเป็นเดือน6 และตั้งแต่วันที่ 21ให้แสดงค่าเป็นฤดูร้อน ถ้าหากเป็นเดือน9และตั้งแต่วันที่21แสดงค่าเป็นฤดูใบไม้ร่วง หากเป็นเดือน12และวันที่ตั้งแต่21ไปต้องแสดงผลเป็นหน้าหนาว และถ้าหากไม่ตรงกับเงื่อไขใดเลย จะเข้าอีกเงื่อนไขคือ หากตรงกับเดือน1,2,3 แสดงค่าออกมาเป็นฤดูหนาว หากตรงกับเดือน 4,5,6 ให้แสดงผลออกมาเป็ฤดูใบไม้ผลิ หากตรงกับเดือน 7,8,9ให้แสดงผลเป็นฤดูร้อน และหากไม่ตรงกับเงื่อนไขใดเลยให้แสดงผลเป็นฤดูใบไม้ร่วง
```
...
```text
กระบวนการเคิดเหมือนวิธีแรก แต่ในเงื่อนไขใน else มีการใช้ in แทนการใช้ or เพื่อลดการเขียนเงื่อนไข
```
...
```text
เพื่อเทสเงื่อนไขว่าถ้าหากเป็นเดือนที่หาร3 ลงตัวและวันมากกว่า21จะแสดงผลฤดูถัดไป
```
...
```text
เป็นการเทสว่าสามาแสดงเดือนออกมาได้ถูกต้องตามเงื่อนไขหรือไม่
```
...
```text
เพื่อทดสอบว่าากเป็นวันที่ 21 และเป็นเดือนที่ หาร3ไม่ลงตัวจะแสดงผลฤดูออกมาได้ถูกต้องหรือไม่
```
