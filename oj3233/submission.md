...
```text
ตรวจว่าเลขสลากกินแบ่งว่าถูกมั๊ย
```
...
```text
รับค่าสลากกินแบ่งที่ถูกมาก่อน จากนั้นรับค่าสลากที่ซื้อ โดยที่เราจตรวจสอบเลขว่าตรงกันมั๊ย จากนั้นค่อยตรวจสอบว่าตัวอักษรตรงมั๊ยถ้าตรง จากนั้นค่อยเช็คตามเงื่อนไขที่โจทย์ให้มา แต่ถ้าหกไม่ตรงกับข้อ
```
...
```text
ใช้เงื่อนไขแบบเดียวกับแบบเดียวกัน แต่มีการแยกการรับค่าแบบตัวอักษร กับตัวเลข แล้วเอาตัวอักษรไปตรวจก่อนว่าเท่ากันมั๊ย แล้วค่อยไล่ดูว่าเลขท้ายตรงมั๊ย
```
...
```text
ตรวจสอบว่าถ้าไม่ตรงเงื่อไขไหนเลยจะแสดงผลเป็น 0 มั๊ย
```
...
```text
เทสเคสถูกรางวัลแบบเลขตรงทั้งหมดแต่ตัวอักษรไม่ตรง
```
...
```text
เทสว่าถ้าตัวอักษรตรง และถูกเลขท้าย 2 ตัวด้วยจะแสดงผลตามค่าที่ให้ไปมั๊ย
```
