...
```text
จากโจทย์ คือให้เราผสมสีจากแม่สีแล้วแสดงผลลัพธ์ว่าได้สีอะไร
เช่นถ้าสีเหลือง + แดง จะได้สี ส้ม
สีแดง + น้ำเงินได้ม่วง 
แต่ถ้าไม่อยู่ในแม่สีจะต้องแสดงค่า error
```
...
```text
อย่างแรกคือรับค่าสีทั้ง 2 สีเข้ามาก่อน
จากนั้นใช้ if-else สร้างเงื่อนไขของแต่ละคู่ว่าต้องออกมาเป็นสีอะไร ถ้าไม่ตรงกับอันไหนเลยให้แสดงว่า error
```
...
```text
รับค่า 2 สีเข้ามาจากนั้นเนื่องจากข้อความที่รับค่าเข้ามาอาจจะมีทั้งตัวใหญ่ตัวเล็ก จึงต้องมีการทำให้เป็นตัวเล็กและมีการใช้sorted(มีการค้นหาวิธีในการใช้)และใช้stripเพื่อตัดช่องว่างข้างเผื่อในกรณีที่พิมพ์ช่องมาด้วย เพื่อใช้ในการเรียงสีจากลำดับตัวอักษรในภาษาอังกฤษ ซึ่งตรงส่วนนี้จะช่วยลดเงื่อนไขในการเขียน จากนั้นเราค่อยเอามาเข้าเงื่อนไขและจับคู่สีแต่ละอัน และต้องจับคู่สีของตัวมันเองด้วย เช่นสีแดง + สีแดง จะต้องได้สีแดงทพยังงี้กับทุกสีในแม่สีจนครบ และหากไม่ตรงเงื่อนไขให้แสดง error
```
...
```text
เพื่อเทสว่าถ้าใส่ตัวพิมพ์ใหญ่จะสามารันผ่านมั๊ย
```
...
```text
เพื่อทดว่าถ้าไม่ตรงเงื่อนไขใดจะแสดง error มั๊ย
```
...
```text
เพื่อดูว่าผลลัพธ์ตรงกับเงื่อนไขมั๊ย
```
